const CARD_DATABASE = [];
        ...
        registerCard({ dbId: 'L-7', archetype: 'Suporte', rarity: 'legendary', name: 'G. do Ouro', tribe: 'Herdeiros', atk: 60, def: 20, hp: 400, maxHp: 400, pa: 5, piCost: 5, habName: 'Tributo Dourado', habDesc: 'HAB: Para cada carta na mão do jogador e do seu oponente essa carta aumenta em 10 o poder de ATK da carta aliada, pode ser usado em si mesmo.)', ultName: 'Decreto da Paz', ultDesc: 'Se o alvo for aliado cura 100% da vida e o deixa pacifista, se for inimigo deixa ele em estado pacifista e ele não poderá causar dano por 1 turno', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/YSMQ151S/G-Ouro.png' });
        registerCard({ dbId: 'L-8', archetype: 'Melee', rarity: 'legendary', name: 'G. da Morte', tribe: 'Esqueletos', atk: 95, def: 15, hp: 400, maxHp: 400, pa: 5, piCost: 5, habName: 'Ecos do Ossário', habDesc: 'HAB: +20 de ATK para cada carta do tipo "Esqueleto" no cemiério e no campo de batalha, além disso 20% do dano sofrido por essa carta é redistribuido para os Esqueletos em campo por 2 turnos', ultName: 'Ceifa do Além', ultDesc: 'Essa carta ganha todo o poder de ataque somado de todas as cartas do tipo "Esqueletos" no cemitério por 1 turno. ', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/9XKTxRG6/G-Morte.png' });
        registerCard({ dbId: 'L-9', archetype: 'Melee', rarity: 'legendary', name: 'G. da Lança', tribe: 'Lanceiros', atk: 80, def: 30, hp: 400, maxHp: 400, pa: 5, piCost: 5, habName: 'Postura da Falange', habDesc: 'HAB: +20 ATK por Lanceiro aliado em campo (2 turnos). Ao causar dano em alvo da linha de frente, aplica 30% do dano causado na backline inimiga.', ultName: 'Lança Implacável', ultDesc: 'ULT: 75% do dano no alvo é aplicado a todos inimigos.', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/5t4sS7vV/G-Lanca.png' });
        registerCard({ dbId: 'L-10', archetype: 'Tank', rarity: 'legendary', name: 'G. da Máscara', tribe: 'Anônimos', atk: 55, def: 35, hp: 500, maxHp: 400, pa: 5, piCost: 5, habName: 'Véu da Máscara', habDesc: 'HAB: -20% dano recebido, +10% dano causado e +2% por 20 de sobrevida (3 turnos). Ganha +20 sobrevida por ataque.', ultName: 'Golpe Oculto', ultDesc: 'ULT: Concede sobrevida (20% HP máx) a todos aliados por 2 turnos.', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/vBDghbDY/G-mascara.png' });
        registerCard({ dbId: 'L-11', archetype: 'Tank', rarity: 'legendary', name: 'G. do Álcool', tribe: 'Pandistas', atk: 55, def: 45, hp: 550, maxHp: 400, pa: 5, piCost: 5, habName: 'Troca de Posição', habDesc: 'HAB: Troca a posição (frente ↔ trás) de uma carta aliada ou inimiga. Custa 1 PA e pode ser usada 2x no turno.', ultName: 'Estado Bêbado', ultDesc: 'ULT: Usa em si mesma para alternar entre BÊBADO (-25% dano recebido) e SÓBRIO (+25% ATK). Permanece até alternar novamente.', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/sgDWnt6d/G-Alcool.png' });
        registerCard({ dbId: 'L-12', archetype: 'Suporte', rarity: 'legendary', name: 'G. da Árvore', tribe: 'Silvestres', atk: 50, def: 15, hp: 400, maxHp: 400, pa: 5, piCost: 5, habName: 'Brinde Bélico', habDesc: 'HAB: Infecta alvo por 2 turnos (veneno = 20% do ATK da L-12). Ao atacar infectado, todas cartas infectadas sofrem 50% do dano.', ultName: 'Rugido do Barril', ultDesc: 'ULT: Infecta todos inimigos e cura aliados em 20% do HP máx. Um aliado ganha +20 ATK por curado (2 turnos).', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/SKRWKwCm/G-ARVORE.png' });
        registerCard({ dbId: 'L-13', archetype: 'Suporte', rarity: 'legendary', name: 'G. das Criaturas', tribe: 'Invocadores', atk: 60, def: 20, hp: 400, maxHp: 400, pa: 5, piCost: 5, habName: 'Seiva Vital', habDesc: 'HAB: Invoca do cemitério (Comum/Rara/Épica) para seu campo. Máx 2 invocações controladas.', ultName: 'Raízes Ancestrais', ultDesc: 'ULT: Controle mental por 1 turno completo; pode mover ao seu campo e usar habilidade/ultimate. Não pode controlar a mesma carta novamente.', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/xCqgWXth/G-invocador.png' });
        registerCard({ dbId: 'L-14', archetype: 'Suporte', rarity: 'legendary', name: 'G. da Tecnologia', tribe: 'Tecmagos', atk: 60, def: 25, hp: 400, maxHp: 400, pa: 5, piCost: 5, habName: 'Engrenagem Arcana', habDesc: 'HAB: Dobra efeitos utilitários aliados por 2 turnos e dá +2 PA agora +2 PA no próximo turno ao alvo.', ultName: 'Núcleo Supremo', ultDesc: 'ULT (6 PA): Suspende buffs/debuffs temporários inimigos por 1 turno, aplica +25% dano recebido por 2 turnos e concede sobrevida 10% aos aliados.', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/zG9fnKKy/G-Tecnologia.png' });
        ...
        registerCard({ dbId: 'L-16', archetype: 'Melee', rarity: 'legendary', name: 'G. da Sorte', tribe: 'Trevos', atk: 80, def: 30, hp: 450, maxHp: 400, pa: 5, piCost: 5, habName: 'Sorte do Trevo', habDesc: 'HAB: Rola 1d6 em um aliado. Chance de converter dano em cura + bônus de ATK por 1 turno completo.', ultName: 'Destino Favorável', ultDesc: 'ULT: Escolha um naipe (Espadas/Copas/Ouro/Paus) e aplique seu efeito por 1 turno completo.', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/bJLDHdzX/G-SORTE.png' });
        registerCard({ dbId: 'L-17', archetype: 'Ranged', rarity: 'legendary', name: 'G. da Pólvora', tribe: 'Bandidos', atk: 75, def: 20, hp: 400, maxHp: 400, pa: 5, piCost: 5, habName: 'Compra Rápida', habDesc: 'HAB: Ativa modo de compra. Clique no deck para comprar 1 carta.', ultName: 'Forçar Compra', ultDesc: 'ULT: Oponente compra 1 carta e você rouba 2 cartas da mão dele.', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/v8N7pSdS/G-Polvora.png' });
        registerCard({ dbId: 'L-18', archetype: 'Ranged', rarity: 'legendary', name: 'G. dos Portais', tribe: 'Vagantes', atk: 85, def: 20, hp: 480, maxHp: 400, pa: 5, piCost: 5, habName: 'Comando de Vanguarda', habDesc: 'HAB: Buff global +20% ATK por 2 turnos; alvo recebe +2 PA agora e +2 PA no próximo turno; Melee/Tank podem atacar a linha de trás por 2 turnos.', ultName: 'Triplo Deslocamento', ultDesc: 'ULT: Envie 1 inimigo do campo ao topo do deck, 1 carta da mão inimiga ao fundo do deck, e 1 carta do cemitério inimigo ao seu cemitério.', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/QxS9WfXq/G-PORTAL.png' });
        ...
        registerCard({ dbId: 'E-1', archetype: 'Suporte', rarity: 'epic', name: 'Carta Épica', tribe: 'Cronomantes', atk: 60, def: 25, hp: 450, maxHp: 400, pa: 4, piCost: 4, habName: 'Eco Cronomântico', habDesc: 'Cura Front Row (50% Dano)', ultName: 'Salto Temporal', ultDesc: 'Buff: +150 ATK', effectType: 'heal_front_on_back_hit', img: 'https://i.postimg.cc/8CgPgdtJ/A18-TEMPO.png' });
        registerCard({ dbId: 'R-1', archetype: 'Ranged', rarity: 'rare', name: 'Arqueiro Mestre', tribe: 'Arqueiros', atk: 70, def: 20, hp: 300, maxHp: 300, pa: 3, piCost: 3, habName: 'Tiro Preciso', habDesc: 'Buff: +20 ATK', ultName: 'Disparo Vampírico', ultDesc: 'Cura 50% Dano', effectType: 'lifesteal', img: 'https://robohash.org/R-1?set=set2&size=300x300' });
        registerCard({ dbId: 'C-1', archetype: 'Melee', rarity: 'common', name: 'Esqueleto Comum', tribe: 'Esqueletos', atk: 40, def: 20, hp: 100, maxHp: 100, pa: 2, piCost: 2, habName: 'Ossos Afiados', habDesc: 'Buff: +10 ATK', ultName: 'Explosão Óssea', ultDesc: 'Dano em Área', effectType: 'splash', img: 'https://robohash.org/C-1?set=set2&size=300x300' });
        registerCard({ dbId: 'C-2', archetype: 'Melee', rarity: 'common', name: 'Esqueleto Comum', tribe: 'Esqueletos', atk: 40, def: 20, hp: 100, maxHp: 100, pa: 2, piCost: 2, habName: 'Ossos Afiados', habDesc: 'Buff: +10 ATK', ultName: 'Explosão Óssea', ultDesc: 'Dano em Área', effectType: 'splash', img: 'https://robohash.org/C-1?set=set2&size=300x300' });
        registerCard({ dbId: 'C-3', archetype: 'Melee', rarity: 'common', name: 'Esqueleto Comum', tribe: 'Esqueletos', atk: 40, def: 20, hp: 100, maxHp: 100, pa: 2, piCost: 2, habName: 'Ossos Afiados', habDesc: 'Buff: +10 ATK', ultName: 'Explosão Óssea', ultDesc: 'Dano em Área', effectType: 'splash', img: 'https://robohash.org/C-1?set=set2&size=300x300' });
        registerCard({ dbId: 'C-4', archetype: 'Melee', rarity: 'common', name: 'Esqueleto Comum', tribe: 'Esqueletos', atk: 40, def: 20, hp: 100, maxHp: 100, pa: 2, piCost: 2, habName: 'Ossos Afiados', habDesc: 'Buff: +10 ATK', ultName: 'Explosão Óssea', ultDesc: 'Dano em Área', effectType: 'splash', img: 'https://robohash.org/C-1?set=set2&size=300x300' });
        registerCard({ dbId: 'U-1', archetype: 'Utility', rarity: 'utility', name: 'Poção de Energia', tribe: 'Item', atk: 0, def: 0, hp: 0, maxHp: 0, pa: 0, piCost: 1, habName: 'Infusão Energética', habDesc: '+3 PA ao alvo', ultName: 'Sem Ultimate', ultDesc: '-', effectType: 'add_pa', img: 'https://robohash.org/U-1?set=set3&size=300x300' });
        ...
        function openBuilderCardModal(card) {
            ...
            const stars = '⭐'.repeat(card.piCost);
            ...
            if (!isUtility) {
                statsHtml = `
                    <div class="modal-stats-row">
                        <span class="modal-stat" style="color:var(--danger)">⚔️ ${card.atk}</span>
                        <span class="modal-stat" style="color:var(--secondary)">❤️ ${card.hp}</span>
                        <span class="modal-stat" style="color:var(--blue)">🛡️ ${card.def}</span>
                        <span class="modal-stat" style="color:var(--gold)">⚡ ${card.pa}</span>
                    </div>
                `;
            }
        ...
        function updateBuilderUI() {
            ...
            if (total >= MIN_DECK_SIZE && total <= MAX_DECK_SIZE) {
                ...
                btn.disabled = false;
                btn.innerText = "IR PARA O LOBBY";
            } else {
                countEl.style.color = 'var(--danger)';
                btn.disabled = true;
                btn.innerText = total < MIN_DECK_SIZE ? `MÍNIMO ${MIN_DECK_SIZE}` : "DECK CHEIO";
            }
        }

        function finishDeckBuilder() {
            selectedDeckList = playerDraft.map(card => card.dbId);
            navigateTo('lobby');
            refreshLobby();
        }
        ...
        function renderLobbyRooms(rooms) {
            ...
            container.innerHTML = '';
            if (!rooms.length) {
                container.innerHTML = '<div style="color:#666; font-size:1.8vh;">Nenhuma sala disponível.</div>';
                return;
            }
            rooms.forEach(room => {
                ...
                entry.innerHTML = `
                    ...
                    <button class="menu-btn" style="padding: 0.6vh 1.2vh; font-size: 1.4vh;">Entrar</button>
                `;
                entry.querySelector('button').onclick = () => joinRoom(room.id);
        ...
        function createRoom() {
            ...
            socket.emit('lobby:create', { name: roomName, deck: selectedDeckList, playerName });
        }

        function joinRoom(roomId) {
            const playerName = document.getElementById('player-name')?.value || '';
            socket.emit('lobby:join', { roomId, deck: selectedDeckList, playerName });
        }
        ...
        function renderRoom(room) {
            ...
            if (list) {
                ...
                room.players.forEach(player => {
                    ...
                    item.className = 'lobby-room-entry';
                    item.innerHTML = `
                        <span>${player.name}</span>
                        <span style="color:${player.ready ? 'var(--secondary)' : 'var(--gray)'}">${player.ready ? 'Pronto' : 'Aguardando'}</span>
                    `;
        ...
        function toggleReady() {
            ...
            if (btn) btn.textContent = isReady ? 'PRONTO!' : 'PRONTO';
            socket.emit('room:ready', { ready: isReady, deck: selectedDeckList });
        }
        ...
        /* --- Helper de Ícones de Arquétipo --- */
        const getArchetypeIcon = (type) => {
            // Mapeie aqui os links das suas imagens para cada arquétipo
            const iconImages = {
        ...
        class Game {
            ...
            handleStealCard(uid) {
                ...
                this.logAction(`Jogador roubou 1 carta da mão do oponente (${this.handStealMode.stolen}/2).`, 'player');
                if (this.handStealMode.remaining <= 0 || this.opp.hand.length === 0) {
                    if (this.handStealMode.remaining > 0) {
                        this.logAction("Não foi possível completar 2 roubos por falta de cartas.", 'player');
                    }
            ...
            returnControlledCard(card) {
                ...
                if (!placed) {
                    ...
                    this.logAction(`<strong>${card.name}</strong> retornou ao cemitério.`, originOwner);
                }
            ...
            applyStartTurnEffects(entity) {
                // Os efeitos com turnsLeft são reduzidos no início do turno do dono.
                if (!entity.teamEffects) entity.teamEffects = [];
            ...
            async executeAction(actionType, source, target) {
                ...
                if (source.dbId === 'L-11' && actionType === 'skill' && this.isL11Drunk(source)) {
                    this.logAction("Habilidade bloqueada: L-11 está bêbada.", sourceController);
                    return;
                }
                ...
                if ((targetMode === 'enemy' || targetMode === 'ally_or_enemy') && !(source.dbId === 'L-11' && actionType === 'skill') && this.isBackRowBlocked(source, target)) {
                    this.logAction("Alvo inválido: frente inimiga ainda está ocupada.", sourceController);
                    return;
                }
                if (source.dbId === 'L-13' && actionType === 'ult' && target && typeof target !== 'string') {
                    if (target.controlImmune || target.controlledBy) {
                        this.logAction("Controle mental falhou: alvo já controlado.", sourceController);
                        return;
                    }
                }
                ...
                if (source.dbId === 'L-15' && actionType === 'ult') {
                    ...
                    if (runeTargets.length === 0) {
                        this.logAction("Ultimate indisponível: nenhuma Runa em campo", sourceController);
                        return;
                    }
                }
                ...
                if (actionType === 'skill' || actionType === 'ult') {
                    ...
                    const targetLabel = targetMode === 'self' ? source.name : (target && typeof target !== 'string' ? target.name : 'Líder Inimigo');
                ...
                if (critInfo.isCrit) {
                    ...
                    this.logAction(`<strong>CRÍTICO!</strong>`, sourceController);
                }
                if (l15SkillBonus !== 1) {
                ...
                if (resolvedTarget === 'player_avatar' || resolvedTarget === 'opp_avatar') {
                    ...
                    if (resolvedTarget.dbId === 'L-8' && this.getActiveEffects(resolvedTarget, 'damage_redirect_skeletons').length > 0) {
                        ...
                        // Redistribui 20% do dano recebido entre Esqueletos aliados (exclui o próprio L-8).
                ...
                if (healCritInfo.isCrit) this.logAction(`<strong>CRÍTICO!</strong>`, sourceController);
            ...
            async executeSupportAction(actionType, source, target) {
                ...
                if (source.dbId === 'L-2' && actionType === 'skill') {
                    ...
                    source.nextAttackFree = { turnsLeft: 1 };
                    this.logAction(`Chance de crítico aumentada!`, this.getCardController(source));
                    return;
                }
                if (source.dbId === 'L-2' && actionType === 'ult') {
                    ...
                    source.nextAttackFree = { turnsLeft: 1 };
                    this.logAction(`Crítico garantido para o time!`, this.getCardController(source));
                    return;
                }
                if (source.dbId === 'L-3' && actionType === 'skill') {
                    ...
                    this.logAction(`Buff de ATK dinâmico ativado!`, this.getCardController(source));
                    return;
                }
                ...
                if (source.dbId === 'L-4' && actionType === 'ult') {
                    const healCritInfo = this.getCritMultiplier(source, 'heal');
                    if (healCritInfo.isCrit) this.logAction(`<strong>CRÍTICO!</strong>`, this.getCardController(source));
                ...
                if (source.dbId === 'L-5' && actionType === 'ult') {
                    ...
                    const srcEl = getCardEl(source);
                    ui.showDamage(srcEl, "Fúria", "#ff4444");
                    if (srcEl) {
                        fx.spawnParticles('buff', srcEl.getBoundingClientRect());
                        fx.spawnRunes(srcEl.getBoundingClientRect(), 2);
                    }
                    this.logAction(`<strong>${source.name}</strong> entrou em fúria!`, this.getCardController(source));
                    return;
                }
                ...
                if (source.dbId === 'L-8' && actionType === 'skill') {
                    ...
                    // Conta Esqueletos do dono (campo + cemitério) para o bônus de ATK.
                ...
                if (source.dbId === 'L-8' && actionType === 'ult') {
                    const ownerEntity = this.getOwnerEntity(source);
                    // Soma ATK base das cartas Esqueletos no cemitério do dono.
                    ...
                    this.logAction(`ATK do cemitério absorvido!`, this.getCardController(source));
                }
                ...
                if (source.dbId === 'L-10' && actionType === 'skill') {
                    ...
                    const srcEl = getCardEl(source);
                    ui.showDamage(srcEl, "VÉU ATIVO", "#4da6ff");
                    if (srcEl) {
                        fx.spawnParticles('buff', srcEl.getBoundingClientRect());
                        fx.spawnRunes(srcEl.getBoundingClientRect(), 2);
                    }
                    this.logAction(`Sobrevida e resistência ativadas!`, this.getCardController(source));
                    return;
                }
                if (source.dbId === 'L-10' && actionType === 'ult') {
                    ...
                    allies.forEach(ally => {
                        ...
                        const allyEl = getCardEl(ally);
                        ui.showDamage(allyEl, `🛡️ +${shieldValue}`, "#4da6ff");
                        if (allyEl) {
                            fx.spawnParticles('buff', allyEl.getBoundingClientRect());
                ...
                if (source.dbId === 'L-11' && actionType === 'skill') {
                    ...
                    this.logAction(`Posição alterada para <strong>${target.name}</strong>.`, this.getCardController(source));
                    ui.renderField();
                    ui.updateHUD();
                    return;
                }
                if (source.dbId === 'L-11' && actionType === 'ult') {
                    ...
                    const srcEl = getCardEl(source);
                    const label = nextState === 'drunk' ? "BÊBADO" : "SÓBRIO";
                    ui.showDamage(srcEl, label, "#ffd700");
                    if (srcEl) {
                        fx.spawnParticles('buff', srcEl.getBoundingClientRect());
                        fx.spawnRunes(srcEl.getBoundingClientRect(), 2);
                    }
                    this.logAction(`Estado ${nextState === 'drunk' ? 'bêbado' : 'sóbrio'} ativado!`, this.getCardController(source));
                    return;
                }
                if (source.dbId === 'L-12' && actionType === 'ult') {
                    ...
                    this.logAction(`Infecção em massa e cura aplicada!`, this.getCardController(source));
                    return;
                }
                if (source.dbId === 'L-13' && actionType === 'skill') {
                    if (!target || typeof target === 'string') {
                        this.logAction("Nenhuma carta selecionada no cemitério.", this.getCardController(source));
                        return;
                    }
                    if (!['common', 'rare', 'epic'].includes(target.rarity)) {
                        this.logAction("Apenas cartas Comuns, Raras ou Épicas podem ser invocadas.", this.getCardController(source));
                        return;
                    }
                    if (this.countNecroSummons() >= 2) {
                        this.logAction("Limite de invocações controladas atingido.", this.getCardController(source));
                        return;
                    }
                    ...
                    if (!placeKey) {
                        this.logAction("Sem espaço no campo!", this.getCardController(source));
                        return;
                    }
                ...
                if (source.dbId === 'L-14' && actionType === 'skill') {
                    ...
                    this.logAction(`Dobra utilitária ativada em <strong>${target.name}</strong>.`, controllerSide);
                    return;
                }
                if (source.dbId === 'L-14' && actionType === 'ult') {
                    ...
                    Object.values(enemyEntity.field).forEach(enemy => {
                        ...
                        const enemyEl = getCardEl(enemy);
                        ui.showDamage(enemyEl, "VULNERÁVEL", "#ff4444");
                        if (enemyEl) fx.spawnParticles('debuff', enemyEl.getBoundingClientRect());
                    });
                    Object.values(controllerEntity.field).forEach(ally => {
                        ...
                        this.syncShieldValue(ally);
                        const allyEl = getCardEl(ally);
                        ui.showDamage(allyEl, `🛡️ +${displayShield}`, "#4da6ff");
                        if (allyEl) {
                            fx.spawnParticles('buff', allyEl.getBoundingClientRect());
                            fx.spawnRunes(allyEl.getBoundingClientRect(), 1);
                        }
                    });
                    this.logAction(`Núcleo Supremo ativado!`, controllerSide);
                    return;
                }
                if (source.dbId === 'L-18' && actionType === 'skill') {
                    ...
                    this.logAction(`${target.name} +2 PA agora e +2 PA no próximo turno.`, controllerSide);
                    this.logAction(`Melee/Tank podem atacar linha de trás por 2 turnos.`, controllerSide);
                    ui.renderField();
                    ui.updateHUD();
                    return;
                }
                if (source.dbId === 'L-18' && actionType === 'ult') {
                    ...
                    const step2Pick = async () => {
                        if (opponentEntity.hand.length === 0) {
                            this.logAction("Triplo Deslocamento: mão inimiga vazia, passo 2 ignorado.", controllerSide);
                            return null;
                        }
                    ...
                    if (pickedHandCard) {
                        ...
                        this.logAction(`Triplo Deslocamento: carta da mão inimiga enviada ao fundo do deck.`, controllerSide);
                    ...
                    const step3Pick = async () => {
                        if (opponentEntity.gy.length === 0) {
                            this.logAction("Triplo Deslocamento: cemitério inimigo vazio.", controllerSide);
                            return null;
                        }
                        if (controllerSide !== 'player') {
                    ...
                    if (pickedGyCard) {
                        ...
                        this.logAction(`Triplo Deslocamento: carta do cemitério inimigo movida para seu cemitério.`, controllerSide);
                        ui.updateGraveyardVisuals();
                    }
                    return;
                }
                if (source.dbId === 'L-16' && actionType === 'skill') {
                    ...
                    this.logAction(`Dado lançado (${roll}) em <strong>${target.name}</strong>.`, this.getCardController(source));
                    return;
                }
                if (source.dbId === 'L-16' && actionType === 'ult') {
                    ...
                    if (!suit) return;
                    const suitMap = {
                        swords: { label: 'Espadas', icon: '⚔️' },
                        hearts: { label: 'Copas', icon: '❤️' },
                        gold: { label: 'Ouro', icon: '♦️' },
                        clubs: { label: 'Paus', icon: '♣️' }
                    };
                    ...
                    this.logAction(`Destino Favorável: ${suitMeta?.label} escolhido.`, controllerSide);
                    return;
                }
                if (source.dbId === 'L-15' && actionType === 'ult') {
                    const controllerSide = this.getCardController(source);
                    ...
                    if (runeTargets.length === 0) {
                        this.logAction("Ultimate indisponível: nenhuma Runa em campo", controllerSide);
                        return;
                    }
                ...
                if (source.dbId === 'L-17' && actionType === 'ult') {
                    ...
                    this.logAction("Oponente comprou 1 carta devido à Ultimate de L-17.", controllerSide);
                    await this.ensureOpponentHand(2, opponentSide);
                    if (controllerSide === 'player') {
                        const available = this.opp.hand.length;
                        if (available === 0) {
                            this.logAction("Não foi possível roubar cartas: mão vazia.", controllerSide);
                            return;
                        }
                        if (available < 2) {
                            this.logAction("Não foi possível completar 2 roubos por falta de deck.", controllerSide);
                        }
                ...
                if (source.dbId === 'L-19' && actionType === 'skill') {
                    ...
                    this.logAction(`Ritmo Temporal: +1 PA agora, +2 PA no próximo turno e 10% de roubo de PA.`, controllerSide);
                    return;
                }
                if (source.dbId === 'L-19' && actionType === 'ult') {
                    ...
                    this.logAction(`Paradoxo do Tempo: próximo ataque rouba PA e time com 40% de roubo.`, controllerSide);
                    return;
                }
            }
        ...
        const sendIntent = (type, payload = {}) => {
            ...
            intentSeq += 1;
            socket.emit('match:intent', { matchId: currentMatchId, seq: intentSeq, type, payload });
        };
        ...
        socket.on('room:update', (room) => {
            ...
            if (me) {
                isReady = !!me.ready;
                if (readyButton) readyButton.textContent = isReady ? 'PRONTO!' : 'PRONTO';
            }
        });
        ...
        function getEffectDurationText(effect) {
            if (!effect) return '';
            if (effect.meta?.permanent) return 'Duração: Permanente (até alternar)';
            const turnsLeft = effect.turnsLeft ?? 0;
            const label = turnsLeft === 1 ? '1 turno' : `${turnsLeft} turnos`;
            return `Duração: ${label}`;
        }
        ...
        function formatEffectForUI(effect) {
            ...
            switch (effect.type) {
                ...
                case 'atk_flat':
                    ...
                    break;
                case 'crit_chance':
                    description = effect.value >= 1 ? 'Essa carta tem 100% de chance de crítico.' : `Essa carta tem +${Math.round(effect.value * 100)}% de chance de crítico.`;
                    break;
                case 'damage_reduction':
                ...
                case 'def_override':
                    ...
                    break;
                case 'damage_immunity':
                    description = 'Esta carta está imune a dano.';
                    break;
                case 'hp_drain_pct':
                    description = `Esta carta sofre drenagem de ${Math.round(effect.value * 100)}% do HP no início do turno.`;
                    break;
                case 'pacifist':
                    description = 'Esta carta não pode causar dano (Pacifista).';
                    break;
                case 'l5_mark':
                    description = 'Esta carta está marcada e aliados drenam 20% do dano causado.';
                    break;
                case 'intercept':
                    description = 'Esta carta intercepta dano para um aliado.';
                    break;
                case 'damage_redirect_skeletons':
                    description = '20% do dano recebido é redirecionado para Esqueletos aliados.';
                    break;
                case 'atk_per_tribe':
                ...
                case 'l9_spill':
                    ...
                    break;
                case 'l9_ult_splash':
                    description = 'Golpe em cadeia: 75% do dano em área.';
                    break;
                case 'atk_shield_mult':
                ...
                case 'shield':
                    ...
                    break;
                case 'infection':
                    description = `Infecção: ${Math.floor(effect.value || 0)} de dano por turno.`;
                    break;
                case 'mind_control':
                ...
                case 'l16_suit_badge':
                    ...
                    break;
                case 'l18_backrow_access':
                    description = 'Esta carta pode atacar a linha de trás mesmo com frente ocupada.';
                    break;
                case 'pa_bonus_start':
                    description = `No início do turno, esta carta recebe +${effect.value} PA.`;
                    break;
                case 'pa_steal_on_damage': {
                ...
                case 'next_attack_steal_pa':
                    description = 'Próximo ataque rouba 1 PA do alvo.';
                    break;
                default:
        ...
        const ui = {
            ...
            updateInfoPanel: () => {
                ...
                if (!card) {
                    ...
                    panel.innerHTML = '<div class="info-panel-placeholder">Clique com o botão direito em uma carta no campo para ver detalhes.</div>';
                    return;
                }
                ...
                panel.innerHTML = `
                    <div class="info-panel-header">
                        ...
                        <div class="info-panel-details">
                            <div>
                                <div class="info-panel-title">HABILIDADE — ${habName}</div>
                                <div class="info-panel-text">${habDesc}</div>
                            </div>
                            <div>
                                <div class="info-panel-title ult">ULTIMATE — ${ultName}</div>
            ...
            cardTemplate: (card) => {
                ...
                const badgesHtml = (diceEffect || suitEffect || runeEffect) ? `
                    <div class="card-status-badges">
                        ${diceEffect ? `<div class="card-badge dice">🎲 ${diceEffect.meta?.roll ?? '?'}</div>` : ''}
                        ${suitEffect ? `<div class="card-badge suit">${suitEffect.meta?.icon ?? '♠️'}</div>` : ''}
                ...
                return `
                    ...
                    <div class="shield-indicator"><span class="shield-icon">🛡️</span>${Math.floor(shieldValue)}</div>
                    ` : ''}
            ...
            updateHUD: () => {
                ...
                if (playerPiEl) playerPiEl.innerHTML = `<span class="hud-star">⭐</span> PI: ${playerPi}`;
                if (oppHpEl) oppHpEl.innerText = `HP: ${oppHp}`;
                if (oppDefEl) oppDefEl.innerText = `DEF: ${oppDef}`;
                if (oppPiEl) oppPiEl.innerHTML = `<span class="hud-star">⭐</span> PI: ${oppPi}`;
            ...
            openGraveyardOverlay: ({ owner = 'player', mode = 'view', sourceCard = null, onSelect = null, selectOwner = null, allowAny = false, allowCancel = true } = {}) => {
                ...
                const title = isSelectMode
                    ? (selectOwner ? `Selecionar Carta do Cemitério ${selectTitleOwner === 'player' ? 'do Jogador' : 'do Oponente'}` : 'Selecionar Carta do Cemitério')
                    : `Cemitério ${owner === 'player' ? 'do Jogador' : 'do Oponente'}`;
                overlay.innerHTML = `
                ...
                const renderSection = (sectionTitle, cards, ownerKey) => {
                    ...
                    if (cards.length === 0) {
                        ...
                        empty.innerText = 'Nenhuma carta no cemitério.';
                ...
                if (isSelectMode) {
                    ...
                    owners.forEach(ownerKey => {
                        const titleLabel = ownerKey === 'player' ? 'Seu Cemitério' : 'Cemitério do Oponente';
                    ...
                    const section = renderSection(owner === 'player' ? 'Seu Cemitério' : 'Cemitério do Oponente', gy, owner);
            ...
            showSuitSelection: (autoPick = false) => {
                return new Promise(resolve => {
                    ...
                    const suits = [
                        { key: 'swords', label: 'Espadas', icon: '⚔️' },
                        { key: 'hearts', label: 'Copas', icon: '❤️' },
                        { key: 'gold', label: 'Ouro', icon: '♦️' },
                        { key: 'clubs', label: 'Paus', icon: '♣️' }
                    ].sort(() => Math.random() - 0.5);
                    overlay.innerHTML = `
                        <div class="suit-modal">
                            <div class="suit-title">Escolha um naipe</div>
                            <div class="suit-hand">
                                <div class="suit-hand-icon">🖐️</div>
                                ${suits.map(suit => `
                                    <div class="suit-card" data-suit="${suit.key}" aria-label="${suit.label}">🂠</div>
                                `).join('')}
                            </div>
                        </div>
                    `;
            ...
            openFieldModal: (card) => {
                ...
                let warning = "";
                if(isFirstPlayerTurnLocked && canControl) warning = "<p style='color:red; text-align:center; font-size:1.2vh;'>No 1º turno, apenas buffs em si mesmo.</p>";
                ...
                if (card.dbId === 'L-15' && !runeAvailable && isPlayerCard && !warning) warning = "<p style='color:orange; text-align:center; font-size:1.2vh;'>Ultimate indisponível: nenhuma Runa em campo.</p>";
                    ...
                    <div class="modal-card">
                         <div class="modal-visual-card ${card.rarity}">
                            <div class="modal-inner">
                                ...
                                <div class="modal-text-area">
                                    <div class="modal-stats-row">
                                        <span class="modal-stat" style="color:var(--danger)">⚔️ ${Math.floor(game.getEffectiveAtk(card))}</span>
                                        <span class="modal-stat" style="color:var(--secondary)">❤️ ${Math.floor(card.currentHp)}</span>
                                        <span class="modal-stat" style="color:var(--blue)">🛡️ ${Math.floor(game.getEffectiveDef(card))}</span>
                                        <span class="modal-stat" style="color:var(--gold)">⚡ ${card.pa}</span>
                                    </div>
                                    <div class="modal-desc-box">
            ...
            initAttack: (uid, type) => {
                ...
                if (type === 'ult' && card.dbId === 'L-15' && game.getRuneTargets(game.getCardController(card)).length === 0) {
                    game.logAction("Ultimate indisponível: nenhuma Runa em campo", game.getCardController(card));
                    return;
                }
...
const arena = document.getElementById('arena-overlay');
                    ...
                    if (target === 'player_avatar' || target === 'opp_avatar') {
                        ...
                        tObj = {
                            ...
                            name: target === 'player_avatar' ? "Líder (Você)" : "Líder (Oponente)",
                    ...
                    // Auto-close for BOTH sides (player and AI) — no OK button, never blocks clicks
        ...
        function playRPS(choice) {
            ...
            resDiv.innerText = `Você: ${choice} vs PC: ${oppChoice}`;
            if(result === 'draw') {
